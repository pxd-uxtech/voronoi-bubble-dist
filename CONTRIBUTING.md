...
// Originally created by @taekie. Licensed under MIT by UXtechLab. See LICENSE for details.
```
...
기여하신 코드는 저장소와 동일한 [MIT](LICENSE) 조건으로 배포됩니다 (Change Date 2029-01-01에 MIT로 전환). PR을 보내는 것은 이 조건에 동의하는 것으로 간주합니다.
