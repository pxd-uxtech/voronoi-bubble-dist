...
import { VoronoiBubble, showVoronoiPopup }
  from 'https://cdn.jsdelivr.net/gh/pxd-uxtech/voronoi-bubble-dist@v2.3.1/dist/voronoi-bubble.standalone.js';
```
...
```javascript
{
  const m = await import("https://cdn.jsdelivr.net/gh/pxd-uxtech/voronoi-bubble-dist@v2.3.1/dist/voronoi-bubble.standalone.js");
...
```html
<script src="https://cdn.jsdelivr.net/gh/pxd-uxtech/voronoi-bubble-dist@v2.3.1/dist/voronoi-bubble.standalone.umd.js"></script>
<script>
